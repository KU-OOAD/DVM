...
public class DrinkManagerTest {
    ...
    void hasDrinkTest() {
        ...
        assertFalse(drinkManager.hasDrink("21", 100), "Should return false when drink is not available");
    }
    ...
    void getDrinkTest() {
        ...
        assertEquals(1500, drink.getDrinkPrice(), "Drink price should be 1000");
